...
try {
    ...
    $mail->addAddress('sandra.mladenovic.66.17@ict.edu.rs');     // Add a recipient               // Name is optional
    $mail->addReplyTo($kome, 'Information');

    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'NewsFeed';
    $mail->Body = "This message is sent so i can fulfill my obligation towards Luka Lukic's website requirements!";
